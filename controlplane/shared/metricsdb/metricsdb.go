...
// remote write, timestamped now. Used for writes that represent a decision made at call time
// (e.g. a quota reservation) rather than a delayed report of something that happened earlier —
// for the latter, use WriteGaugeAt with the event's own true timestamp.
