...
ladder (controller/stages_rank.go ranks agents on the observed spread) can never separate them
again — a full tie group is always kept whole, so no one is ever cut.
"""
